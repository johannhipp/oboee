# Archived policy-v2 production audit

> Historical record only. This audit describes the policy-v2 product surface that was removed by the MVP scope reset. Its findings are not acceptance criteria for the current marketplace MVP. See `../mvp-dogfood-20260715.md` for the current QA contract.
