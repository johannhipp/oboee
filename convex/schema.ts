...
export default defineSchema({
  ...
  /**
   * Records the documents and storage blobs owned by the local frontend
   * fixture. The seed mutation is nonproduction-only, but keeping ownership
   * explicit makes reset safe and repeatable instead of relying on titles or
   * user ids that may collide with real development data.
   */
  devFixtureRecords: defineTable({
    fixtureName: v.string(),
    entityId: v.union(
      v.id("rfs"),
      v.id("rfsRevisions"),
      v.id("rfsCriteria"),
      v.id("fixtureVersions"),
      v.id("fixtureUploadIntents"),
      v.id("skills"),
      v.id("skillVersions"),
      v.id("evaluationEvents"),
      v.id("reviewerReputations"),
      v.id("authorReputations"),
      v.id("payoutAssessments"),
      v.id("purchases"),
      v.id("accessGrants"),
      v.id("payoutLedger"),
      v.id("payoutEntries"),
      v.id("contributions"),
      v.id("applicationRevisions"),
      v.id("rfsApplications"),
      v.id("applicationEndorsements"),
      v.id("principalWallets"),
      v.id("walletVerificationChallenges"),
      v.id("principalSigningKeys"),
      v.id("proofKeyChallenges"),
      v.id("publicProfiles"),
      v.id("agentDelegations"),
      v.id("apiKeyAuthorizations"),
      v.id("privilegedSessionAttestations"),
      v.id("humanActionRequests"),
      v.id("accountRecoveryRequests"),
      v.id("accountRecoveryChallenges"),
      v.id("platformRoles"),
      v.id("operatorAuditEvents"),
      v.id("identityRiskSignals"),
      v.id("identityClusters"),
      v.id("identityClusterMemberships"),
      v.id("identityClusterEvents"),
      v.id("paymentIntents"),
      v.id("idempotencyRecords"),
      v.id("apiOperations"),
      v.id("apiRateLimits"),
      v.id("activityEvents"),
      v.id("artifactUploadIntents"),
      v.id("evidenceArtifacts"),
      v.id("evidenceAccessEvents"),
      v.id("evaluationCriterionResults"),
      v.id("reviewAssignments"),
      v.id("disputes"),
      v.id("disputeEvents"),
      v.id("assessmentEvents"),
      v.id("bondEscrows"),
      v.id("bondEvents"),
      v.id("settlementObligations"),
      v.id("settlementTransfers"),
      v.id("purchasePayoutBatches"),
      v.id("reputationEvents"),
      v.id("postUseReviews"),
      v.id("postUseReviewRevisions"),
      v.id("postUseReviewResponses"),
      v.id("quarantineEvents"),
      v.id("skillQualitySnapshots"),
      v.id("authorReputationSnapshots"),
      v.id("reviewerTrustSnapshots"),
      v.id("installEvents"),
      v.id("discoveryProjection"),
      v.id("featureFlags"),
      v.id("policyShadowComparisons"),
      v.id("migrationProgress"),
      v.id("migrationReviewItems"),
      v.id("paymentEvents"),
    ),
    storageId: v.optional(v.id("_storage")),
    createdAt: v.number(),
  }).index("by_fixture", ["fixtureName"]),
});
